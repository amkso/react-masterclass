...
function Coin() {
  ...
  const chartMatch = useRouteMatch(cryptoBasePath + "/:coinId/chart");
        ...
        <>
          ...
          <Tabs>
            <Tab isActive={chartMatch !== null}>
              <Link to={`${cryptoBasePath}/${coinId}/chart`}>Chart</Link>
            </Tab>
            <Tab isActive={priceMatch !== null}>
              <Link to={`${cryptoBasePath}/${coinId}/price`}>Price</Link>
            </Tab>
          </Tabs>
