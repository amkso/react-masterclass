...
function Header() {
  ...
  const bookmarkedMatch = useRouteMatch(netflixBasePath + "/bookmarked");
      ...
      <Nav variants={navVariants} animate={navAnimation} initial="top">
        ...
        <Col>
          ...
          <Items>
            ...
            <Item>
              <Link to={netflixBasePath}>영화</Link>
            </Item>
            <Item>NEW! 요즘 대세 콘텐츠</Item>
            <Item>
              <Link to={netflixBasePath + "/bookmarked"}>
                내가 찜한 리스트{" "}
                {bookmarkedMatch && <Circle layoutId="circle" />}
              </Link>
            </Item>
            <Item>언어별로 찾아보기</Item>
          </Items>
        ...
        <Col>
          ...
          <div style={{ textShadow: "1px 1px 2px black" }}>키즈</div>
          <motion.svg
          ...
          <div>
            <span style={{ textShadow: "1px 1px 2px black" }}>프로필</span>
            <motion.svg
