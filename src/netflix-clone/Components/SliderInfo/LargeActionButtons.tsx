...
interface LargeActionButtonsProps {
  content: any;
  datatype:
    | "movie"
    | "series"
...
function LargeActionButtons({ content, datatype }: LargeActionButtonsProps) {
  ...
  const handleBookmark = (e: React.MouseEvent) => {
    ...
    if (isBookmarked) {
      ...
      // bookmarked 페이지에서 북마크 해제 시 뒤로 가기
      if (window.location.pathname.includes("/bookmarked")) {
        history.goBack();
      }
    } else {
